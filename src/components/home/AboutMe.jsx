  ...
  return (
    <section className='w-full relative lg:bg-[url("/bg.webp")] bg-[url("/bgMobile.webp")] bg-contain'>
        <div className="w-full md:flex lg:w-11/12 mx-auto block py-10 lg:py-20">
          <div className='text-center lg:w-2/5 w-5/6 mx-auto lg:-rotate-12 hover:rotate-0 transition-all duration-500'>
          ...
          <div className='lg:w-1/2 w-full p-2 lg:pl-8 transition-all duration-500'>
            <div className="w-11/12 mx-auto bg-white p-4 px-8 lg:rotate-12 rounded-2xl shadow-xl transition-all duration-500 hover:shadow-2xl hover:rotate-0 shadow-black/30 hover:shadow-black/60">
